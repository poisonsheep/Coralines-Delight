package io.github.poisonsheep.coralinesdelight.resources;
...
public class BBModelLoader extends SimplePreparableReloadListener<Map<ResourceLocation, JsonElement>> {
    ...
    public static final Map<ResourceLocation, io.github.poisonsheep.coralinesdelight.resources.bbmodel.BBModel> MODELS = new HashMap<>();
    ...
    protected Map<ResourceLocation, JsonElement> prepare(ResourceManager resourceManager, ProfilerFiller profiler) {
        ...
        for (Map.Entry<ResourceLocation, Resource> entry : resourceManager.listResources("objects", n -> n.getPath().endsWith(".bbmodel")).entrySet()) {
            ...
            try {
                ...
                CoralinesDelight.LOGGER.error("Couldn't parse data file {} from {}", id, location, exception);
            }
        }
        return map;
    }
    ...
    protected void apply(Map<ResourceLocation, JsonElement> jsonMap, ResourceManager resourceManager, ProfilerFiller profiler) {
        MODELS.clear();
        jsonMap.forEach((identifier, jsonElement) -> MODELS.put(identifier, new io.github.poisonsheep.coralinesdelight.resources.bbmodel.BBModel(jsonElement.getAsJsonObject(), identifier)));
    }
}
